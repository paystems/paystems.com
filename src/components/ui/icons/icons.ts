export const Icons = {
  ...
  youtubeFooter: {
    paths: [
      {
        d: "M23.498 6.186a2.99 2.99 0 0 0-2.106-2.117C19.228 3.5 12 3.5 12 3.5s-7.228 0-9.392.569a2.99 2.99 0 0 0-2.106 2.117C0 8.351 0 12 0 12s0 3.649.502 5.814a2.99 2.99 0 0 0 2.106 2.117C4.772 20.5 12 20.5 12 20.5s7.228 0 9.392-.569a2.99 2.99 0 0 0 2.106-2.117C24 15.649 24 12 24 12s0-3.649-.502-5.814zM9.75 15.568V8.432L15.75 12l-6 3.568z",
      },
    ],
  ...
  linkedinFooter: {
    paths: [
      {
        d: "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.352V9h3.414v1.561h.049c.476-.9 1.637-1.852 3.368-1.852 3.602 0 4.268 2.368 4.268 5.452v6.291zM5.337 7.433c-1.144 0-2.07-.927-2.07-2.07 0-1.144.926-2.07 2.07-2.07 1.144 0 2.07.926 2.07 2.07 0 1.143-.926 2.07-2.07 2.07zM6.993 20.452H3.681V9h3.312v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.226.792 24 1.771 24h20.451C23.208 24 24 23.226 24 22.271V1.729C24 .774 23.208 0 22.225 0z",
      },
    ],
    class: "h-4 w-4 flex-shrink-0 fill-current text-neutral-700 dark:text-neutral-400",
    viewBox: "0 0 24 24",
  ...
  redditFooter: {
    paths: [
      {
        d: "M20.742 10.339c-.547 0-1.045.229-1.398.586-1.852-1.229-4.365-2.016-7.148-2.094l1.438-6.761 4.713 1.008c0 1.008.82 1.828 1.828 1.828 1.008 0 1.828-.82 1.828-1.828S21.109 0 20.101 0c-.774 0-1.438.502-1.684 1.193l-5.303-1.137c-.229-.049-.457.093-.502.32l-1.621 7.621c-2.783.093-5.271.874-7.123 2.094-.365-.384-.874-.586-1.398-.586C.82 10.339 0 11.159 0 12.167c0 .684.365 1.274.911 1.621-.046.32-.091.638-.091.957 0 3.821 4.547 6.918 10.182 6.918 5.635 0 10.182-3.097 10.182-6.918 0-.319-.046-.638-.091-.957.547-.32.911-.911.911-1.621 0-1.008-.82-1.828-1.828-1.828zm-14.65 5.911c0-1.008.82-1.828 1.828-1.828s1.828.82 1.828 1.828c0 1.008-.82 1.828-1.828 1.828s-1.828-.82-1.828-1.828zm9.593 3.229c-.957.957-2.783 1.008-3.229 1.008-.456 0-2.273-.046-3.229-1.008-.137-.137-.137-.365 0-.502.137-.137.365-.137.502 0 .73.73 2.273.82 2.773.82.501 0 2.043-.091 2.773-.82.137-.137.365-.137.502 0 .137.137.137.365-.001.502zm-.911-1.401c-1.008 0-1.828-.82-1.828-1.828 0-1.008.82-1.828 1.828-1.828s1.828.82 1.828 1.828c0 1.008-.82 1.828-1.828 1.828z",
      },
    ],
    class: "h-4 w-4 flex-shrink-0 fill-current text-neutral-700 dark:text-neutral-400",
    viewBox: "0 0 24 24",
