...
hero:
  ...
  image:
      alt: A PayStems's Logo
      dark: ../../../images/starlight/paystems_hero.svg
      light: ../../../images/starlight/paystems_hero_dark.svg
  actions:
    - text: Get started
      icon: right-arrow
      variant: primary
    ...
    - text: View on GitHub
      icon: external
      variant: minimal
      link: https://github.com/mearashadowfax/PayStems
---
...
<CardGrid stagger>
  ...
  <Card title="Outils et Équipements" icon="seti:eslint">
    Découvrez la gamme complète d'outils et d'équipements de qualité supérieure de PayStems. Chaque sous-section offre des spécifications détaillées, des instructions d'utilisation et des conseils de maintenance.
  </Card>
